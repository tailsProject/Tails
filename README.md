...
| 날짜 | 내용 |
| --- | --- |
| 2026.07.05 | 프로젝트 시작, 초기 세팅 |
| 2026.07.09 ~ 07.11 | 회원, 장소, 게시판, 여행, 댓글 등 핵심 도메인 API 1차 구현 |
| 2026.07.12 ~ 07.14 | 이미지 업로드, 리뷰, 장소 검색 기능 고도화 및 예외 처리 정비 |
| 2026.07.15 ~ 07.17 | 알림, 소셜 로그인, 리프레시 토큰, 여행 경로 최적화, 관리자 권한, FCM 푸시 구현 |
| 2026.07.20 | Pet CRUD, 인기 장소/평점 순위, 여행 페이징 등 백엔드 핵심 기능 완료 |
| 2026.07.21 ~ 07.23 | 이메일 인증, 게시판/댓글/이미지 개선, 인증 보안 패치 및 알려진 버그 수정 |
| 2026.07.24 ~ 07.26 | 상세 응답 null 가드, 정렬/enum 파라미터 처리 등 버그 수정으로 안정화 |
| 2026.07.28 ~ 07.29 | 대댓글, 관리자 관리 기능, 장소 동기화 개선, 소셜 로그인 연동, Pet 사진 업로드 구현 |
| 2026.07.31 ~ 08.03 | 프론트엔드 전체 단계(0~7단계) 구현 완료 (공통 UI, 인증 플로우, 여행 플래너, 지도, 마이페이지 등) |
| 2026.08.04 | 게시판 피드, 메인 대시보드, 관리자 패널 완료 및 README 문서 정리, 배포 마무리 |
| 2026.08.05 | 배포 후 마이페이지 알림, 지도 검색, 관리자/메인, 여행, 댓글 아바타 등 버그 수정 |
